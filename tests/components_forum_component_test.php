 ...
 * @group     tool_ally
 * @group     ally
 * @covers    \tool_ally\componentsupport\forum_component
 */
final class components_forum_component_test extends abstract_testcase {
    ...
    /**
     * Asserts that content items contain discussion post.
     */
    ...
    /**
     * Asserts that content items do not contain discussion post.
     */
